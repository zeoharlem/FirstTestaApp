...
class CategoryAdapter: ListAdapter<Category, CategoryAdapter.CategoryViewHolder>(CategoryDiffUtil) {
    ...
    inner class CategoryViewHolder(private val viewBinding: CategoryItemBinding): ViewHolder(viewBinding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryViewHolder {
        ...
        val viewBinding = CategoryItemBinding.inflate(layoutInflater, parent, false)
